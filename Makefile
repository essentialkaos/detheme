...
all: detheme ## Build all binaries

detheme:
	@echo "[36;1mBuilding detheme…[0m"
	@go build $(VERBOSE_FLAG) -ldflags="-X main.gitrev=$(GITREV)" detheme.go

install: ## Install all binaries
	@echo "[36;1mInstalling binaries…[0m"
	@cp detheme /usr/bin/detheme

uninstall: ## Uninstall all binaries
	@echo "[36;1mRemoving installed binaries…[0m"
	@rm -f /usr/bin/detheme
